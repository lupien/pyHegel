...
#        self.write('SYSTem : OVERPROT off')
    ...
    def _create_devs(self):
        ...
        self.delay_start = scpiDevice(pre+'STARt:DELay', str_type=scaled_float(1e-3), min=10e-3, max=60, setget=True)
        self.delay_stop = scpiDevice(pre+'STOP:DELay', str_type=scaled_float(1e-3), min=0, max=50e-3, setget=True)
        ...
        self.step_width = scpiDevice(pre+'VOLTage:STep:WIDth', str_type=scaled_float(1e-3), min=5e-3, max=60, setget=True, doc='Used for trig mode STEP')
